...
import { LayoutGrid, Shirt, Icon } from 'lucide-react-native';
import { dress } from "@lucide/lab";
import { store } from 'expo-router/build/global-state/router-store';

const home = () => {
  const filterIcons = [
    { name: "Dress", icon: (props) => <Icon iconNode={dress} {...props} /> }, 
  ...
  const products = [
  {
    ...
    products: [{
      id: 1,
      image: require("../../assets/images/Sample Card Images/img3.jpg"),
  ...
  },
  {
    ...
    products: [{
      id: 2,
      image: require("../../assets/images/Sample Card Images/img2.jpg"),
      title: "Blue Dress",
      price: "2699.99",
  ...
  },
  {
    ...
    products: [{
      id: 3,
      image: require("../../assets/images/Sample Card Images/img1.jpg"),
      title: "White T-Shirt",
      price: "19.99",
  ...
  },
  {
    ...
    products: [{
      id: 4,
      image: require("../../assets/images/Sample Card Images/img4.jpg"),
      title: "Black T-Shirt",
      price: "24.99",
